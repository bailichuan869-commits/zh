...
title: 企业合并补偿性资产
type: case
case_type: business-combination
created: 2026-07-29
updated: 2026-08-05
page_role: case
maturity: reviewed
...
raw_path: raw/standards/accounting/application-case-attachments/039-P020260618436842966610.pdf.md
tags: [case, golden-case, accounting, official-application]
related: [[concepts/accounting-judgments/business-combinations-purchase-date-contingent-consideration]], [[cases/golden-cases-index]]
domain: cases
...
购买日被补偿项目是否确认、补偿权是否可收回、赔付门槛、个别和合并报表层次、后续判决信息属于何时事实。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[concepts/accounting-judgments/business-combinations-purchase-date-contingent-consideration|对应黄金专题]]
- [[raw/standards/accounting/application-case-attachments/039-P020260618436842966610.pdf.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/application-case-attachments/039-P020260618436842966610.pdf.md|财政部案例或实施问答原文]]

## 时效与限制

本页整理日期为 2026-07-29。正式使用前应核验报告期适用准则和财政部后续更新。审计程序与底稿建议属于专业判断补充，不是财政部原文内容。
