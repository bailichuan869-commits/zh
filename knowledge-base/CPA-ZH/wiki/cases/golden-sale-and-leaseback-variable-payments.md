...
raw_path: raw/standards/accounting/application-case-attachments/035-P020231207298200718851.pdf.md
...
转让是否满足收入准则销售、租回权利比例、预期付款能否合理估计、实际付款与估计差异。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[raw/standards/accounting/application-case-attachments/035-P020231207298200718851.pdf.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/application-case-attachments/035-P020231207298200718851.pdf.md|财政部案例或实施问答原文]]
