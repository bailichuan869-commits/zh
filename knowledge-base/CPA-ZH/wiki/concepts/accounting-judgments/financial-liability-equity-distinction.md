...
sources: [cas-37]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第37号-金融工具列报-财会〔2017〕14号.html.md
tags: [accounting, judgment, golden-topic, cas-37]
related: [[concepts/accounting-standards/cas-37]], [[concepts/accounting-judgments/index]]
...
用于判断与“金融负债与权益工具区分”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

合同是否要求交付现金、发行人能否无条件避免、结算股数和金额、或有结算条款、清算顺序、补充协议。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-37|企业会计准则第37号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第37号-金融工具列报-财会〔2017〕14号.html.md|财政部准则原文]]
...
- [[cases/golden-liability-equity-investor-protection|投资者保护条款下负债与权益区分]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第37号-金融工具列报-财会〔2017〕14号.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-37|准则资料入口]]
