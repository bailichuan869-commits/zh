...
本页记录第二板块 7 份政策文件的官方原文归档情况。归档文件位于 `knowledge-base/CPA-ZH/raw/policies/second-section/`，每份文件目录下包含 `official.html`、`metadata.json` 和 `source-url.txt`。
...
- `raw/` 层作为原始资料层，归档后原则上不直接改写官方原文。
- 若官方页面迁移或文件修订，应新增归档批次或在对应目录补充新版本，不覆盖旧版本。
- `manifest.json` 汇总本批次归档文件、URL、字节数和对应 wiki 页面。
