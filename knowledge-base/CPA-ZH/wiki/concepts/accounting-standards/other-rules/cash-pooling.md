...
以下资料来自 [[concepts/accounting-standards/unmapped-review]] 的人工校准建议，建议桶为“其他规定 / 资金集中管理”。
这些条目保留原始官方链接和本地 HTML 路径，后续应结合原文继续核验后再纳入正式映射。

| 类型 | 标题 | 置信度 | 理由 | 官方链接 | 本地文件 |
|---|---|---|---|---|---|
| 应用案例 | 资金集中管理会计处理应用案例 | medium | 更接近专题性会计处理规定 | https://kjs.mof.gov.cn/zt/kjzzss/srzzzq/202201/t20220124_3784577.htm | `raw/standards/accounting/application-cases-pages/023-资金集中管理会计处理应用案例.html` |
