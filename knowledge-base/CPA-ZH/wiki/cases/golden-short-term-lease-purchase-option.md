...
raw_path: raw/standards/accounting/implementation-qa-pages-v2/qa-032.html.md
tags: [case, golden-case, accounting, official-application]
related: [[concepts/accounting-judgments/lease-term-modification-sale-leaseback]], [[cases/golden-cases-index]]
domain: cases
topic: lease
...
购买选择权是否真实存在及合同整体是否为租赁；不因预计不行权而忽略明文排除。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[concepts/accounting-judgments/lease-term-modification-sale-leaseback|对应黄金专题]]
- [[raw/standards/accounting/implementation-qa-pages-v2/qa-032.html.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/implementation-qa-pages-v2/qa-032.html.md|财政部案例或实施问答原文]]
