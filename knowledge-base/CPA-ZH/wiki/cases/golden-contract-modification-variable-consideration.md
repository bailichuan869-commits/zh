...
raw_path: raw/standards/accounting/application-case-attachments/010-P020201211508217975565.pdf.md
...
合同开始日是否已有导致隐含可变对价的惯例；新增商品是否可明确区分；新增价格是否反映单独售价。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[concepts/accounting-judgments/revenue-contract-control-transfer|对应黄金专题]]
- [[raw/standards/accounting/application-case-attachments/010-P020201211508217975565.pdf.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/application-case-attachments/010-P020201211508217975565.pdf.md|财政部案例或实施问答原文]]
