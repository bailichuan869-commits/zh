...
raw_path: raw/standards/accounting/implementation-qa-pages-v2/qa-010.html.md
tags: [case, golden-case, accounting, official-application]
related: [[concepts/accounting-judgments/debt-restructuring-recognition-measurement]], [[cases/golden-cases-index]]
domain: cases
...
交易是否确属日常活动、原债务是否终止确认、存货账面价值及相关税费。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[concepts/accounting-judgments/debt-restructuring-recognition-measurement|对应黄金专题]]
- [[raw/standards/accounting/implementation-qa-pages-v2/qa-010.html.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/implementation-qa-pages-v2/qa-010.html.md|财政部案例或实施问答原文]]
