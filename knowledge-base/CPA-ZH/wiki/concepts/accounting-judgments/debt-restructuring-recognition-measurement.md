...
sources: [cas-12]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第12号-债务重组.html.md
tags: [accounting, judgment, golden-topic, cas-12]
related: [[concepts/accounting-standards/cas-12]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/201910/t20191028_3410789.htm
---
# 债务重组确认时点与损益计量
...
用于判断与“债务重组确认时点与损益计量”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

债权债务终止确认时点、清偿资产账面价值、修改后合同现金流、权益工具公允价值、是否属于日常活动。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-12|企业会计准则第12号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第12号-债务重组.html.md|财政部准则原文]]
...
- [[cases/golden-inventory-settles-debt|以存货清偿债务]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第12号-债务重组.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-12|准则资料入口]]
