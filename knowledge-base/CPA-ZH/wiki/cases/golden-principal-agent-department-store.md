...
raw_path: raw/standards/accounting/application-case-attachments/009-P020201211394278955107.pdf.md
...
向客户承诺的特定商品、转让前调配权、退换货和滞销品最终风险。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[raw/standards/accounting/application-case-attachments/009-P020201211394278955107.pdf.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/application-case-attachments/009-P020201211394278955107.pdf.md|财政部案例或实施问答原文]]
