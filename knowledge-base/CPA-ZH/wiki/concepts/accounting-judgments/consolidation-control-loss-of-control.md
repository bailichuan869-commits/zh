...
sources: [cas-33]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第33号-合并财务报表.html.md
tags: [accounting, judgment, golden-topic, cas-33]
related: [[concepts/accounting-standards/cas-33]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46248.htm
---
# 合并范围、实质控制与丧失控制权
...
用于判断与“合并范围、实质控制与丧失控制权”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

被投资方相关活动、现时权利、可变回报、权力影响回报能力、代理人关系、结构化主体、处置安排整体性。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-33|企业会计准则第33号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第33号-合并财务报表.html.md|财政部准则原文]]
...
- [[cases/2026-07-first-issue-long-term-equity-investment-confirmation|长期股权投资转换确认案例]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第33号-合并财务报表.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-33|准则资料入口]]
