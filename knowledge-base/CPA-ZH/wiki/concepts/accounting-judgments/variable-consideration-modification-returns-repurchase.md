...
用于判断与“可变对价、合同变更、退货与回购”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

可变条款及惯例、重大转回约束、变更批准、剩余商品是否可明确区分、退货概率、回购价格与客户经济动因。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。
