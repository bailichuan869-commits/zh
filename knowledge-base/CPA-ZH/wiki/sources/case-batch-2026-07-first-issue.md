---
title: 2026年7月第一期实务案例导入批次
type: source
source_type: local-case-batch
created: 2026-06-29
updated: 2026-06-29
...
原始文件不在 wiki 层直接改写，后续如需加工，应在 `wiki/cases/` 或相关专题页中生成案例卡片。
...
```powershell
.\.venv\Scripts\python.exe tools\kb_search.py query "7月 第一期 案例"
.\.venv\Scripts\python.exe tools\kb_search.py query "政府补助确认"
.\.venv\Scripts\python.exe tools\kb_search.py query "长期股权投资 确认"
