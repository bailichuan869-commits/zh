...
sources: [cas-08]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第8号-资产减值.html.md
tags: [accounting, judgment, golden-topic, cas-08]
related: [[concepts/accounting-standards/cas-08]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46240.htm
---
# 资产减值与商誉减值
...
用于判断与“资产减值与商誉减值”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

减值迹象、资产组边界、现金流预测、预算期及长期增长率、折现率、商誉分摊和协同效应。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-08|企业会计准则第08号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第8号-资产减值.html.md|财政部准则原文]]
...
- [[cases/golden-sale-and-leaseback-variable-payments|含可变付款的售后租回]]
- [[cases/golden-business-combination-indemnification-asset|企业合并补偿性资产]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第8号-资产减值.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-08|准则资料入口]]
