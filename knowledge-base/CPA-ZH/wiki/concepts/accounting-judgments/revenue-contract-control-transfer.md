...
sources: [cas-14]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第14号-收入.html.md
tags: [accounting, judgment, golden-topic, cas-14]
related: [[concepts/accounting-standards/cas-14]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/201709/t20170907_2694006.htm
---
# 收入合同识别与控制权转移
...
用于判断与“收入合同识别与控制权转移”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

合同批准、权利和付款条款、商业实质、客户支付能力、履约义务、控制权证据。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-14|企业会计准则第14号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第14号-收入.html.md|财政部准则原文]]
...
- [[cases/golden-custom-software-revenue|定制软件开发服务收入确认]]
- [[cases/golden-contract-modification-variable-consideration|合同变更与可变对价]]
- [[cases/golden-standard-software-revenue-timing|标准化软件收入确认时点]]
- [[cases/golden-presale-property-revenue|预售商品房收入确认]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第14号-收入.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-14|准则资料入口]]
