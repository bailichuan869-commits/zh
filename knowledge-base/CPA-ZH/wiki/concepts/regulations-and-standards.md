...
本板块沉淀注册会计师执业需要长期掌握的上位法律、会计准则体系和审计准则体系。
...
- [[concepts/law-cpa]] - 注册会计师行业主体、资格、业务范围与法律责任。
- [[concepts/law-accounting]] - 会计核算、会计监督、财务会计报告和会计责任。
- [[concepts/law-company]] - 公司治理、股东权利、董监高责任、财务会计制度。
- [[concepts/law-securities]] - 证券发行、信息披露、中介机构责任和监管处罚。
- [[concepts/accounting-standards-system]] - 企业会计准则、应用指南及解释。
- [[concepts/audit-standards-system]] - 中国注册会计师执业准则及应用指南。
- [[concepts/first-section-topic-matrix]] - 按收入、金融工具、合并范围、持续经营、关键审计事项、证券服务责任等实务问题串联本板块依据。
...
- [[concepts/first-section-topic-matrix]] - 第一板块专题矩阵入口。
- [[concepts/core-laws-official-verification]] - 法律版本核验入口。
- [[concepts/first-section-responsibility-risk-map]] - 法律责任和审计风险总表。
