...
sources: [cas-01]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第1号-存货.html.md
tags: [accounting, judgment, golden-topic, cas-01]
related: [[concepts/accounting-standards/cas-01]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46216.htm
---
# 存货确认、成本与可变现净值
...
用于判断与“存货确认、成本与可变现净值”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

存货是否由企业控制、成本归集是否完整、售价和至完工销售成本是否有可靠证据。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-01|企业会计准则第01号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第1号-存货.html.md|财政部准则原文]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第1号-存货.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-01|准则资料入口]]
