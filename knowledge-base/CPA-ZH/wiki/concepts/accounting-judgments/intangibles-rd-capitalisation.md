...
tags: [accounting, judgment, golden-topic, cas-06]
...
用于判断与“无形资产及研发支出资本化”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

研究与开发阶段分界、技术可行性、完成和使用意图、市场或内部有用性、资源保障、支出可靠计量。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-06|企业会计准则第06号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第6号-无形资产.html.md|财政部准则原文]]
...
- [[cases/golden-data-resource-rd-capitalisation|数据资源研发支出资本化]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第6号-无形资产.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-06|准则资料入口]]
