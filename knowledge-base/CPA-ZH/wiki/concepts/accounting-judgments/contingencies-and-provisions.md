...
sources: [cas-13]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第13号-或有事项.html.md
tags: [accounting, judgment, golden-topic, cas-13]
related: [[concepts/accounting-standards/cas-13]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46235.htm
---
# 或有事项与预计负债
...
用于判断与“或有事项与预计负债”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

现时义务是否存在、经济利益流出可能性、金额能否可靠计量、最佳估计和补偿权利。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-13|企业会计准则第13号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第13号-或有事项.html.md|财政部准则原文]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第13号-或有事项.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-13|准则资料入口]]
