...
sources: [cas-21]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第21号-租赁.html.md
tags: [accounting, judgment, golden-topic, cas-21]
related: [[concepts/accounting-standards/cas-21]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/201910/t20191028_3411190.htm
---
# 租赁期、租赁变更与售后租回
...
用于判断与“租赁期、租赁变更与售后租回”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

可执行期间、续租和终止选择权经济动因、购买选择权、变更范围和对价、转让是否满足收入准则。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-21|企业会计准则第21号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第21号-租赁.html.md|财政部准则原文]]
...
- [[cases/golden-long-term-equity-investment-scope|长期股权投资适用范围]]
- [[cases/golden-short-term-lease-purchase-option|含购买选择权的短期租赁]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第21号-租赁.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-21|准则资料入口]]
