...
sources: [cas-17]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第17号-借款费用.html.md
tags: [accounting, judgment, golden-topic, cas-17]
related: [[concepts/accounting-standards/cas-17]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46231.htm
---
# 借款费用资本化
...
用于判断与“借款费用资本化”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

符合资本化条件的资产、资产支出发生、借款费用发生、购建活动开始、中断性质和达到预定可使用状态。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-17|企业会计准则第17号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第17号-借款费用.html.md|财政部准则原文]]
...
- [[cases/golden-data-resource-rd-capitalisation|数据资源研发支出资本化]]（相关资本化判断案例）
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第17号-借款费用.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-17|准则资料入口]]
