...
raw_path: raw/standards/accounting/application-case-attachments/006-P020200717333926647357.pdf.md
...
客户在建控制权的法律可执行性、任一时点终止合同时对累计履约成本及合理利润的求偿权。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[raw/standards/accounting/application-case-attachments/006-P020200717333926647357.pdf.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/application-case-attachments/006-P020200717333926647357.pdf.md|财政部案例或实施问答原文]]
