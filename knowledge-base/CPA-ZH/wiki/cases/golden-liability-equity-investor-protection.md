---
title: 投资者保护条款下负债与权益区分
type: case
case_type: financial-instruments
created: 2026-07-29
updated: 2026-08-05
page_role: case
maturity: reviewed
...
raw_path: raw/standards/accounting/application-case-attachments/028-P020220913413509669238.pdf.md
tags: [case, golden-case, accounting, official-application]
related: [[concepts/accounting-judgments/financial-assets-classification-derecognition-ecl]], [[cases/golden-cases-index]]
domain: cases
...
触发事件是否真实、是否由发行人控制、持有人大会决议是否对发行人具有合同约束力。 在将本案例迁移到实际项目时，还必须取得完整合同、报告期、交易金额、关联关系和期后变化；缺少这些事实时只能给条件化结论。
...
- [[concepts/accounting-judgments/financial-assets-classification-derecognition-ecl|对应黄金专题]]
- [[raw/standards/accounting/application-case-attachments/028-P020220913413509669238.pdf.md|财政部原文]]
...
- [S1] [[raw/standards/accounting/application-case-attachments/028-P020220913413509669238.pdf.md|财政部案例或实施问答原文]]
