...
sources: [cas-04]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第4号-固定资产.html.md
tags: [accounting, judgment, golden-topic, cas-04]
related: [[concepts/accounting-standards/cas-04]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46213.htm
---
# 固定资产初始确认、后续支出与暂估转固
...
用于判断与“固定资产初始确认、后续支出与暂估转固”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

达到预定可使用状态日期、工程决算状态、后续支出带来的未来经济利益、替换部件账面价值。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-04|企业会计准则第04号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第4号-固定资产.html.md|财政部准则原文]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第4号-固定资产.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-04|准则资料入口]]
