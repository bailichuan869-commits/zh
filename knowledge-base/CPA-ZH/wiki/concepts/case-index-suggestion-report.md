...
| case-other | [[cases/2026-07-first-issue-government-grant-free-use-equipment]] | 个人意见：这类“免费使用设备、但设备所有权并未转移”的安排，通常不宜直接按政府补助确认。实务中更常见的处理是：不确认政府补助，按实际发生的相关费用和租赁/使用安排处理。 | 已出现 |
| case-other | [[cases/2026-07-first-issue-long-term-equity-investment-confirmation]] | 个人意见：A 公司原持有 D 公司的长期股权投资转为对 C 公司的长期股权投资时，应按原账面价值结转，不宜按公允价值重新计量，也不应确认投资收益。 | 已出现 |
...
| consolidation | [[cases/2026-08-first-issue-consolidation-structured-platform]] | 现有材料不足以支持 A 公司实现出表。不能仅凭 A 无单方表决权得出不控制结论；应分别识别正常期、预警期和违约期最显著影响回报的相关活动，再判断 A 的运营处置权、B 的预警处置… | 已出现 |
| leases | [[cases/2026-08-first-issue-lease-asset-not-ready]] | 应先判断交易是真实租赁还是融资公司仅代付购置款的“以租代买”。真实租赁下，设备于 2025 年 7 月交付且由承租人主导安装时，很可能已到租赁期开始日；以租代买下则应确认在建工程… | 已出现 |
...
| fixed-assets | [[cases/2026-08-first-issue-space-test-bench-capitalization]] | 收费试车是达到预定可使用状态的强证据，但不是自动结论。应锁定首次证明试车台能够按设计目的安全、稳定提供服务的日期；转固前必要测试不计折旧，转固后发生的试车应按工作量法在对应期间计… | 已出现 |
| business-combination | [[cases/golden-business-combination-indemnification-asset]] | 企业合并补偿性资产 | 建议补入 |
| 收入确认 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 政府补助 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 长期股权投资 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 固定资产与所得税 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| revenue-recognition | [[cases/golden-contract-modification-variable-consideration]] | 合同变更与可变对价 | 建议补入 |
| revenue-recognition | [[cases/golden-custom-software-revenue]] | 定制软件开发服务收入确认 | 建议补入 |
| intangible-assets | [[cases/golden-data-resource-rd-capitalisation]] | 数据资源研发支出资本化 | 建议补入 |
| financial-instruments | [[cases/golden-expected-credit-loss-simplified]] | 预期信用损失简化模型 | 建议补入 |
| debt-restructuring | [[cases/golden-inventory-settles-debt]] | 以存货清偿债务 | 建议补入 |
| financial-instruments | [[cases/golden-liability-equity-investor-protection]] | 投资者保护条款下负债与权益区分 | 建议补入 |
| accounting-judgment | [[cases/golden-long-term-equity-investment-scope]] | 长期股权投资适用范围 | 建议补入 |
| revenue-recognition | [[cases/golden-presale-property-revenue]] | 预售商品房收入确认 | 建议补入 |
| revenue-recognition | [[cases/golden-principal-agent-department-store]] | 百货联营主要责任人与代理人 | 建议补入 |
| share-based-payment | [[cases/golden-restricted-shares]] | 授予限制性股票 | 建议补入 |
| lease | [[cases/golden-sale-and-leaseback-variable-payments]] | 含可变付款的售后租回 | 建议补入 |
| share-based-payment | [[cases/golden-shareholder-backstop-incentive]] | 大股东兜底式股权激励 | 建议补入 |
| lease | [[cases/golden-short-term-lease-purchase-option]] | 含购买选择权的短期租赁 | 建议补入 |
| revenue-recognition | [[cases/golden-standard-software-revenue-timing]] | 标准化软件收入确认时点 | 建议补入 |
...
| 待人工指定 | [[cases/golden-business-combination-indemnification-asset]] | 企业合并补偿性资产 | 建议补入 |
| 待人工指定 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 待人工指定 | [[cases/golden-contract-modification-variable-consideration]] | 合同变更与可变对价 | 建议补入 |
| 待人工指定 | [[cases/golden-custom-software-revenue]] | 定制软件开发服务收入确认 | 建议补入 |
| 待人工指定 | [[cases/golden-data-resource-rd-capitalisation]] | 数据资源研发支出资本化 | 建议补入 |
| 待人工指定 | [[cases/golden-expected-credit-loss-simplified]] | 预期信用损失简化模型 | 建议补入 |
| 待人工指定 | [[cases/golden-inventory-settles-debt]] | 以存货清偿债务 | 建议补入 |
| 待人工指定 | [[cases/golden-liability-equity-investor-protection]] | 投资者保护条款下负债与权益区分 | 建议补入 |
| 待人工指定 | [[cases/golden-long-term-equity-investment-scope]] | 长期股权投资适用范围 | 建议补入 |
| 待人工指定 | [[cases/golden-presale-property-revenue]] | 预售商品房收入确认 | 建议补入 |
| 待人工指定 | [[cases/golden-principal-agent-department-store]] | 百货联营主要责任人与代理人 | 建议补入 |
| 待人工指定 | [[cases/golden-restricted-shares]] | 授予限制性股票 | 建议补入 |
| 待人工指定 | [[cases/golden-sale-and-leaseback-variable-payments]] | 含可变付款的售后租回 | 建议补入 |
| 待人工指定 | [[cases/golden-shareholder-backstop-incentive]] | 大股东兜底式股权激励 | 建议补入 |
| 待人工指定 | [[cases/golden-short-term-lease-purchase-option]] | 含购买选择权的短期租赁 | 建议补入 |
| 待人工指定 | [[cases/golden-standard-software-revenue-timing]] | 标准化软件收入确认时点 | 建议补入 |
...
| 待人工分类 | [[cases/golden-business-combination-indemnification-asset]] | 企业合并补偿性资产 | 建议补入 |
| 收入提前确认 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 政府支持收益化 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 收入提前确认 | [[cases/golden-contract-modification-variable-consideration]] | 合同变更与可变对价 | 建议补入 |
| 收入提前确认 | [[cases/golden-custom-software-revenue]] | 定制软件开发服务收入确认 | 建议补入 |
| 待人工分类 | [[cases/golden-data-resource-rd-capitalisation]] | 数据资源研发支出资本化 | 建议补入 |
| 待人工分类 | [[cases/golden-expected-credit-loss-simplified]] | 预期信用损失简化模型 | 建议补入 |
| 政府支持收益化 | [[cases/golden-inventory-settles-debt]] | 以存货清偿债务 | 建议补入 |
| 待人工分类 | [[cases/golden-liability-equity-investor-protection]] | 投资者保护条款下负债与权益区分 | 建议补入 |
| 待人工分类 | [[cases/golden-long-term-equity-investment-scope]] | 长期股权投资适用范围 | 建议补入 |
| 收入提前确认 | [[cases/golden-presale-property-revenue]] | 预售商品房收入确认 | 建议补入 |
| 收入提前确认 | [[cases/golden-principal-agent-department-store]] | 百货联营主要责任人与代理人 | 建议补入 |
| 待人工分类 | [[cases/golden-restricted-shares]] | 授予限制性股票 | 建议补入 |
| 待人工分类 | [[cases/golden-sale-and-leaseback-variable-payments]] | 含可变付款的售后租回 | 建议补入 |
| 待人工分类 | [[cases/golden-shareholder-backstop-incentive]] | 大股东兜底式股权激励 | 建议补入 |
| 待人工分类 | [[cases/golden-short-term-lease-purchase-option]] | 含购买选择权的短期租赁 | 建议补入 |
| 收入提前确认 | [[cases/golden-standard-software-revenue-timing]] | 标准化软件收入确认时点 | 建议补入 |
...
| 待人工分类 | [[cases/golden-business-combination-indemnification-asset]] | 企业合并补偿性资产 | 建议补入 |
| 控制权转移备忘录 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 政府补助判断备忘录 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 税会差异测算表 | [[cases/golden-cases-index]] | 会计判断黄金案例 | 建议补入 |
| 控制权转移备忘录 | [[cases/golden-contract-modification-variable-consideration]] | 合同变更与可变对价 | 建议补入 |
| 控制权转移备忘录 | [[cases/golden-custom-software-revenue]] | 定制软件开发服务收入确认 | 建议补入 |
| 待人工分类 | [[cases/golden-data-resource-rd-capitalisation]] | 数据资源研发支出资本化 | 建议补入 |
| 待人工分类 | [[cases/golden-expected-credit-loss-simplified]] | 预期信用损失简化模型 | 建议补入 |
| 待人工分类 | [[cases/golden-inventory-settles-debt]] | 以存货清偿债务 | 建议补入 |
| 待人工分类 | [[cases/golden-liability-equity-investor-protection]] | 投资者保护条款下负债与权益区分 | 建议补入 |
| 待人工分类 | [[cases/golden-long-term-equity-investment-scope]] | 长期股权投资适用范围 | 建议补入 |
| 控制权转移备忘录 | [[cases/golden-presale-property-revenue]] | 预售商品房收入确认 | 建议补入 |
| 控制权转移备忘录 | [[cases/golden-principal-agent-department-store]] | 百货联营主要责任人与代理人 | 建议补入 |
| 待人工分类 | [[cases/golden-restricted-shares]] | 授予限制性股票 | 建议补入 |
| 待人工分类 | [[cases/golden-sale-and-leaseback-variable-payments]] | 含可变付款的售后租回 | 建议补入 |
| 待人工分类 | [[cases/golden-shareholder-backstop-incentive]] | 大股东兜底式股权激励 | 建议补入 |
| 待人工分类 | [[cases/golden-short-term-lease-purchase-option]] | 含购买选择权的短期租赁 | 建议补入 |
| 控制权转移备忘录 | [[cases/golden-standard-software-revenue-timing]] | 标准化软件收入确认时点 | 建议补入 |
