...
本页用于沉淀中国注册会计师行业的发展脉络、制度建设、协会治理、监管体系和行业功能。行业史的价值不在于背年份，而在于理解为什么今天反复强调独立性、诚信、质量管理和监管协同。
...
| 阶段 | 关键理解 | 与当前知识库连接 |
|---|---|---|
| 恢复重建 | 注册会计师制度恢复，是市场经济和会计监督体系建设的重要组成部分 | [[concepts/law-cpa]], [[concepts/policy-audit-order]] |
| 法制确立 | 《注册会计师法》确立注册、事务所、业务范围和法律责任 | [[concepts/law-cpa]] |
| 脱钩改制 | 事务所从行政挂靠走向独立执业，独立性成为行业公信力基础 | [[concepts/independence-standard-1]] |
| 准则建设 | 审计准则、职业道德守则和质量管理要求持续完善 | [[concepts/audit-standards-system]], [[concepts/ethics-code]] |
| 质量提升 | 从规模扩张转向质量导向和一体化管理 | [[concepts/policy-audit-order]], [[concepts/policy-firm-inspection]] |
| 财会监督协同 | 注册会计师行业被纳入更广义的财会监督体系 | [[concepts/policy-caihui-supervision]] |

## 监管逻辑

| 历史问题 | 制度回应 | 实务落点 |
|---|---|---|
| 审计独立性不足 | 职业道德守则、独立性准则、脱钩改制 | 客户承接、人员安排、非鉴证服务、收费安排均要做独立性评价 |
| 行业质量参差 | 执业准则、质量管理、一体化监管 | 事务所不能只管报告签发，还要管底稿、复核和整改闭环 |
