...
sources: [cas-20]
raw_path: raw/standards/accounting/standards-pages/企业会计准则第20号-企业合并.html.md
tags: [accounting, judgment, golden-topic, cas-20]
related: [[concepts/accounting-standards/cas-20]], [[concepts/accounting-judgments/index]]
...
source_url: https://kjs.mof.gov.cn/zt/kjzzss/kuaijizhunzeshishi/200806/t20080618_46228.htm
---
# 企业合并、购买日与或有对价
...
用于判断与“企业合并、购买日与或有对价”直接相关的确认、计量、列报和披露问题。涉及税务、法律可执行性、估值或其他准则交叉事项时，应同时取得相应专业证据，不能把本专题替代具体合同和最新有效准则。

## 决定性事实

是否构成业务、控制取得日、同一控制关系、对价组成、或有对价条款、补偿性资产、购买日前关系。信息不足时，应先补齐这些事实并给出条件化回答，不强行输出唯一结论。

## 准则入口

- [[concepts/accounting-standards/cas-20|企业会计准则第20号入口]]
- [[raw/standards/accounting/standards-pages/企业会计准则第20号-企业合并.html.md|财政部准则原文]]
...
- [S1] [[raw/standards/accounting/standards-pages/企业会计准则第20号-企业合并.html.md|企业会计准则原文]]
- [S2] [[concepts/accounting-standards/cas-20|准则资料入口]]
